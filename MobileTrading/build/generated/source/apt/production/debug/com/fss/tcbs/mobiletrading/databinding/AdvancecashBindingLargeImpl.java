...
public class AdvancecashBindingLargeImpl extends AdvancecashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.relativeTiepTuc, 43);
        sViewsWithIds.put(R.id.lblTiepTuc, 44);
        sViewsWithIds.put(R.id.btnTiepTuc, 45);
    }
    // views
    @NonNull
    ...
    public AdvancecashBindingLargeImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 46, sIncludes, sViewsWithIds));
    }
    private AdvancecashBindingLargeImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
